// Test function for Spine 4.0 runtime validation
#define SPINE_VERSION_STRING "4.0"
...
extern "C" __declspec(dllexport) bool testLoadSkeletonJson40(const char* jsonPath, const char* atlasPath) {
